...
/**
 * Fork from `ra-data-json-server` because we dont need `ra-core`
 */

/**
 * Maps tushan queries to a json-server powered REST API
 *
 ...
 * import { Tushan, jsonServerProvider } from 'tushan';
 *
 * const App = () => (
 *     <Tushan dataProvider={jsonServerProvider('http://jsonplaceholder.typicode.com')}>
 *         ...
 *     </Tushan>
 * );
 *
